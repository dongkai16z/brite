...
public class DMLExport {
    ...
    private void WriteRouter(Graph g, Node asNode, Graph asG) {
        ...
        try {
            ...
            nw.write("\t  Net [  ");
            nw.newLine();
            nw.write("\t   AS_status boundary");
            nw.newLine();
            nw.write("\t   ospf_area 0");
            nw.newLine();
        } catch (IOException e) {
        ...
        if (g == null) {
            try {
                ...
                nw.newLine();
                nw.write("\t ] #end of router-net");
                nw.newLine();

                nw.write("\t]  #end of as def");
                nw.newLine();
                nw.newLine();
            } catch (IOException e) {
    ...
    private void WriteHeaders() {
        try {
            mw.newLine();
            mw.write("#BRITE topology output to DML");
            mw.newLine();
            mw.newLine();
            mw.newLine();
            ...
            mw.write("Net [ ");
            mw.newLine();
            mw.write("\tfrequency 1000000000 \t #1 nanosecond time resolution");
            mw.newLine();
            mw.write("\trandomstream [");
            mw.newLine();
            mw.write("\t   generator \"MersenneTwister\"");
            mw.newLine();
            mw.write("\t   stream \"startseed\"");
            mw.newLine();
            mw.write("\t   reproducibility_level \"timeline\"");
            mw.newLine();
            mw.write("\t]");
            mw.newLine();
            mw.newLine();
            ...
            nw.newLine();
            nw.write("#BRITE topology output to DML");
            nw.newLine();
            nw.write("Net definitions go here.");
            nw.newLine();
            nw.newLine();
