...
public class OtterExport {
    ...
    private void writeColorValueItems() throws IOException {
        bw.write("g 0 d 1 Node Values");
        bw.newLine();
        bw.write("f 0 Degree");
        bw.newLine();
        bw.write("g 1 d 1 Node Classification");
        bw.newLine();
        bw.write("f 1 Corresponding AS");
        bw.newLine();
        bw.write("g 2 d 2 Edge Values");
        bw.newLine();
        bw.write("f 2 Bandwidth'Distance");
        bw.newLine();
    }
